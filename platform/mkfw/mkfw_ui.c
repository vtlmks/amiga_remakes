...
static char *mkui_vertex_shader =
	"#version 130\n"
...
static char *mkui_fragment_shader =
	"#version 130\n"
...
static void mkui_draw_text(struct mkui_draw_list *dl, float x, float y, char *text, struct mkui_color col) {
	float cx = x;
	float cy = y;
...
static uint32_t mkui_gen_id(char *label) {
...
static int32_t mkui_checkbox(char *label, int32_t *checked) {
	uint32_t id = mkui_gen_id(label);
...
static int32_t mkui_slider_float(char *label, float *value, float min_val, float max_val) {
	uint32_t id = mkui_gen_id(label);
...
static int32_t mkui_slider_int(char *label, int32_t *value, int32_t min_val, int32_t max_val) {
	uint32_t id = mkui_gen_id(label);
...
static int32_t mkui_slider_int64(char *label, int64_t *value, int64_t min_val, int64_t max_val) {
	uint32_t id = mkui_gen_id(label);
...
static int32_t mkui_radio_button(char *label, int32_t *selected, int32_t value) {
	uint32_t id = mkui_gen_id(label);
...
static int32_t mkui_collapsing_header(char *label, int32_t *open) {
	uint32_t id = mkui_gen_id(label);
...
static int32_t mkui_text_input(char *label, char *buffer, int32_t buffer_size) {
	uint32_t id = mkui_gen_id(label);
...
static int32_t mkui_combo(char *label, int32_t *current_item, char **items, int32_t items_count) {
	uint32_t id = mkui_gen_id(label);
	...
	char *current_text = (*current_item >= 0 && *current_item < items_count) ? items[*current_item] : "";
...
static int32_t mkui_listbox(char *label, int32_t *current_item, char **items, int32_t items_count, int32_t visible_items) {
	uint32_t id = mkui_gen_id(label);
...
static void mkui_begin_window(char *title, float *x, float *y, float w, float h) {
